...
<div style="display: flex; justify-content: center; margin-top:60px;">
   ...
   @if(session('success'))
    ...
    <div class="dvk">
        ...
        @if(isset($bonusData))
        <form action="{{ url('/admin/bonus') }}" method="POST">
            ...
            <table>
                <tbody>
                   ...
                   <input type="number" name="gift_bonus_amount[]" value="{{ $data->gift_bonus_amount }}" required spellcheck="false" min="0.01" step="0.01">
                   <label>Gift bonus Earn Balance</label>
                            ...
                            <td style="display:none;"><input type="text" name="gift_bonus_code[]" value="{{ $data->gift_bonus_code }}"></td>
                            <td style="display:none;"><input type="text" name="login_bonus_amount[]" value="{{ $data->login_bonus_amount }}"></td>
                            <td style="display:none;"><input type="text" name="login_bonus_code[]" value="{{ $data->login_bonus_code }}"></td>
                            <td style="display:none;"><input type="text" name="spin_bonus_amount[]" value="{{ $data->spin_bonus_amount }}"></td>
    ...
    @if(isset($bonusData))
        <form action="{{ url('/admin/bonus') }}" method="POST" style=" margin-top: 40px;">
            ...
            <table>
                <tbody>
                    @foreach ($bonusData as $data)
                        <tr>
                            <td style="display:none;"><input type="text" name="gift_bonus_amount[]" value="{{ $data->gift_bonus_amount }}"></td>
                            ...
                            <td>
                                <div class="input-field">
                   <input type="text" name="gift_bonus_code[]" id="giftBonusCode" value="{{ $data->gift_bonus_code }}" required spellcheck="false">
...
<script>
                ...
                <tbody>
                    @foreach ($bonusData as $data)
                        <tr>
                            ...
                            <td>
                                <div class="input-field">
                   <input type="number" name="login_bonus_amount[]" value="{{ $data->login_bonus_amount }}" required spellcheck="false" spellcheck="false" min="0.01" step="0.01"> 
    ...
    @if(isset($bonusData))
        <form action="{{ url('/admin/bonus') }}" method="POST" style=" margin-top: 40px; display: none;">
                ...
                <tbody>
                    @foreach ($bonusData as $data)
                        <tr>
                            ...
                            <td style="display:none;"><input type="text" name="gift_bonus_code[]" value="{{ $data->gift_bonus_code }}"></td>
                            <td style="display:none;"><input type="text" name="login_bonus_amount[]" value="{{ $data->login_bonus_amount }}"></td>
                            <td><input type="text" name="login_bonus_code[]" id="randomLettersInput" value="{{ $data->login_bonus_code }}"></td>
                            <td style="display:none;"><input type="text" name="spin_bonus_amount[]" value="{{ $data->spin_bonus_amount }}"></td>
                            <!-- Diğer sütunlar buraya eklenmeli -->
                        </tr>
                    @endforeach
...
<div id="merhabaPopup" class="popup">
                ...
                <tbody>
                    @foreach ($bonusData as $data)
                        <tr>
                            ...
                            <td style="display:none;"><input type="text" name="gift_bonus_code[]" value="{{ $data->gift_bonus_code }}"></td>
                            <td style="display:none;"><input type="text" name="login_bonus_amount[]" value="{{ $data->login_bonus_amount }}"></td>
                            <td><input style="display:none;" type="text" name="login_bonus_code[]" value="{{ $data->login_bonus_code }}"></td>
                            
                            
                            <td>
                                <div class="input-field">
                   <input type="text" name="spin_bonus_amount[]" value="{{ $data->spin_bonus_amount }}" required spellcheck="false" spellcheck="false" min="0.01" step="0.01"> 
    ...
    <a href="{{ url('/admin/reset-spin-record') }}" class="btn button2">
        Reset
    </a>
</div>
    </div>
