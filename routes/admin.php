...
use App\Http\Controllers\SpinRecordResetController;
use Illuminate\Support\Facades\Route;



Route::get('/reset-spin-record', [SpinRecordResetController::class, 'resetSpinRecord']);
// routes/admin.php


Route::get('/bonus', [BonusController::class, 'index'])->name('admin.bonus');
Route::post('/bonus', [BonusController::class, 'update']);
