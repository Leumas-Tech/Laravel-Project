<link rel="stylesheet" href="<?php echo e(asset('frontend/css/about.css')); ?>"/>
...
<div class="uwe">
    ...
    <h3 class="title" style="display: flex; justify-content: center; font-size: 20px; color: white;"><?php echo e(__('ABOUT')); ?></h3>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/resources/views/frontend/user/about.blade.php ENDPATH**/ ?>