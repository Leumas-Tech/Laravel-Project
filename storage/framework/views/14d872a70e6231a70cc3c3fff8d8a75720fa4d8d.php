...
<div style="display: flex; justify-content: center; margin-bottom: 10px;">
  <img src="/resources/views/frontend/img2/201123.jpg" class="rrr" />
</div>

<?php $__env->startSection('content'); ?>
    <div class="row" style="margin-top: -20px;">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="site-card" style="background: url(/resources/views/frontend/img/34492.jpg);background-size: 100% 100%;border-radius: 10px; box-shadow: 0 0 50px rgba(44, 46, 48, 1);">
                ...
                <div class="site-card-body">
                    <div class="referral-link">
                        <div class="referral-link-form">
                            ...
                            <button style="width: 100%; border: 1px solid #15FFDF; border-radius: 5px; background-color: #0E0E0E; color: #15FFDF; font-size: 15px; font-weight: bold;" type="submit" onclick="copyRef()">
...
.orsl {
    ...
    <div style="width:100%; height:30px; display: flex; justify-content: center; border-radius: 10px 10px 3px 3px; background-color: red; margin-bottom: 10px; margin-top: -20px; background: url(/resources/views/frontend/img/34492.jpg);background-size: 100% 100%;">
        <p style="font-size: 14px;
    color: white; text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue; margin-top: 5px;">Team Earnings: Level 1: 15% - Level 2: 8% - Level 3: 6%</p>
    </div>
...
<?php echo $__env->make('frontend.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/resources/views/frontend/referral/index.blade.php ENDPATH**/ ?>