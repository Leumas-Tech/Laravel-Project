    ...
    <div class="notify fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
        ...
        >
            <div class="relative rounded-lg shadow-xs overflow-hidden">
                <div class="p-4" style="width:80%; border: 1px solid #15FFDF; border-radius: 50px; background-color: #0E0E0E; color: #15FFDF; font-size: 15px; font-weight: bold; position: fixed;
  top: 50%;
  left: 50%;
...
<?php endif; ?>
<?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/vendor/mckenziearts/laravel-notify/src/../resources/views/notifications/toast.blade.php ENDPATH**/ ?>