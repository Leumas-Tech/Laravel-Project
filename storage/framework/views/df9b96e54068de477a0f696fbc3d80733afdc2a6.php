...
<section style="background: url(/resources/views/frontend/img2/3288.png); background-size: 100% 100%; height: 750px;">
    
     <img onclick="window.location.href='/h5/index.php/vip'" class="image" src="/resources/views/frontend/img2/close.png">
  ...
  <h1 style="color: #8993A9;">Protocol</h1>
    ...
    <div class="content5">
        ...
        <p style="color: #6e706c; font-size: 14px;">Thank you for using our products and services. The services are provided by Oree Solar. Oree Solar, established in the United States, owns and manages the Oree Solar platform. The Oree Solar Physical Solar Panel Leasing Service Agreement (hereinafter referred to as the "Agreement") is the relevant service terms and includes the included risk statement. The Oree Solar platform is used by users and Oree Solar for the physical solar panel leasing service under the Oree Solar Private Banking Department. The user acknowledges that they have fully read, understood, and accepted all the contents of this agreement before accepting the service. When the user clicks the "I Accept" box or button after signing this agreement or benefiting from the service, the user declares that they fully understand this agreement and are bound by both the user and Oree Solar in the form of information messages, and they accept this agreement.</p>
        ...
        <div style="height: 2px;"></div>
        <p style="color: #6e706c; font-size: 14px;">
            1. Service Content: Oree Solar uses its own system and device partners to offer the leasing of solar panels and other possible new projects on the basis of Oree Solar and the Oree Solar Private Banking Area. Additional services/products.
        </p>
        <div style="height: 2px;"></div>
        <p style="color: #6e706c; font-size: 14px;">
        ...
        <div style="height: 2px;"></div>
        <p style="color: #6e706c; font-size: 14px;">
            (2) To update user information when any changes occur. If the registration information provided by the user is illegal, inaccurate, misleading, or incomplete, the user bears the relevant responsibility, and Oree Solar reserves the right to suspend the user's use of Oree Solar services.
        </p>

        <div style="height: 2px;"></div>
        <p style="color: #6e706c; font-size: 14px;">
            (3) Under the [Oree Solar Private Banking Area], no cooperation or agency agreement has been made with any third-party individual or group until this agreement is signed. The Oree Solar platform will not review, endorse, or accept any response to any third-party website requesting access to [Oree Solar Private Banking Area] services.
        </p>
    ...
    <div style="height: 20px;"></div>
    <div style="text-align: center;">
        <button onclick="otomatikTikla()" class="site-btn" style="border: 1px solid #15FFDF; border-radius: 10px; background-color: #0E0E0E; color: #15FFDF; font-size: 15px; font-weight: bold; width: 80%;">
                                    To Accept
                                </button>
</div>
...
<?php echo $__env->make('frontend.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/resources/views/frontend/schema/preview.blade.php ENDPATH**/ ?>