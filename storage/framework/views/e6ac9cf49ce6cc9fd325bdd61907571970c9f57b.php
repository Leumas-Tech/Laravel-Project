...
<?php $__env->startSection('content'); ?>
  ...
  <div class="center-image">
    <img src="/resources/views/frontend/img2/8305.png" alt="Resim">
  </div>
      ...
      <label 
        ...
        Exchange Amount
            ...
            <div class="buttons" style="display: flex; justify-content: center;">
                <button type="submit" class="site-btn blue-btn" style="border: 1px solid #15FFDF; border-radius: 10px; background-color: #0E0E0E; color: #15FFDF; font-size: 15px; font-weight: bold; width: 300px;">
...
<?php echo $__env->make('frontend.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/resources/views/frontend/wallet/index.blade.php ENDPATH**/ ?>