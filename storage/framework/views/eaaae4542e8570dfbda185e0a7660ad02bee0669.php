...
<style>
        ...
        .popup1 {
            ...
            margin: 0;
    padding: 0;
    background-image: url('/resources/views/frontend/img2/spnbckgrn.png');
    ...
    <div id="popup1" class="popup1">
        ...
        /* Popup Content */
        .popup-content {
    background: url(/resources/views/frontend/img/VAh6Ypw5g3g.jpg);
 ...
 .success {
   ...
   <div id="wheel-container">
      <img id="wheel" src="/resources/views/frontend/img2/spin.png" alt="Wheel">
      <img id="inner-image" src="/resources/views/frontend/img2/spin-ok.png">
   </div>
...
<script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var spinAudio = new Audio('/resources/views/frontend/img/spin-efect.wav');
            var buttonAudio = new Audio('/resources/views/frontend/img/button-efect.wav');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u718774278/domains/1.ponziscript.com/public_html/resources/views/frontend/extra/luckyspin.blade.php ENDPATH**/ ?>